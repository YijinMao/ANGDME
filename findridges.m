...
% Ridge detection algorithm, i.e., Algorithm 1 in paper:
...
% The algorithm is originally introduced in the paper: 
...
% Spec: Time-Frequency distribution of the signal
% delta: maximum allowable frequency variation between two consecutive points
% index: The obtained frequency indexs at each time instant
